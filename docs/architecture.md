...
Phase 9のローカル製造では、`PrinterProfile`または`ManufacturingProfile`候補に機体だけでなく、導電性フィラメント・ペースト・インクの抵抗率、異方性、最小線幅・層厚、電流容量、基材適合性、硬化／焼結温度、密着性、耐久性を含め、材料依存のDRC入力にします。導電体を含む筐体や非平面の構造エレクトロニクスは将来方向であり、Phase 1の平面PCB実装へ持ち込みません。
