...
| live sourcing APIやオンラインdatasheet取得は実装していない                                                                                                                     | AIオーケストレーションと外部sourcingはPhase 5範囲、自働発注はPhase 7範囲、定期的な検証・監視への展開はPhase 8範囲。Phase 4受入対象外とし、datasheet検証経路の追加は別契約として扱う                                                                 |
